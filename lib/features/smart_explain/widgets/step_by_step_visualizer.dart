...
class _StepByStepVisualizerState extends State<StepByStepVisualizer>
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildAnimatedFlowVisual(currentStage),
              const SizedBox(height: 20),

              // Current Stage Explanation Box
              _buildStageExplanationBox(currentStage),
              const SizedBox(height: 20),
  ...
  Widget _buildAnimatedFlowVisual(_WorkflowStage stage) {
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: isBidirectional
                                    ...
                                    : (isRightToLeft ? AppColors.blueLight : AppColors.tealLight),
  ...
  Widget _buildStageExplanationBox(_WorkflowStage stage) {
    return Container(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isCompleted
                            ? AppColors.greenLight
                            : (isActive ? AppColors.tealPrimary : AppColors.surfaceSecondary),
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: isCompleted
                              ? AppColors.greenPrimary
                              : (isActive ? AppColors.tealPrimary : AppColors.cardBorder),
                        ),
                      ),
                      child: Center(
                        child: isCompleted
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isActive ? AppColors.tealPrimary : AppColors.textPrimary,
                        ),
                      ),
                    ),
                    if (isActive)
